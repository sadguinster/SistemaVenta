	   	...
	   	$sql_registe = mysqli_query($conection,"SELECT COUNT(*) as total_registro FROM producto WHERE status != 10 ");
			...
			$total_pagina = ceil($total_registro / $por_pagina);
				...
				if ($pagina < $total_pagina) {
					$lista.= '<li><a href="javascript:listaProductos('.($pagina+1).');"><i class="fas fa-caret-right"></i></a></li><li><a href="javascript:listaProductos('.($pagina+1).');"><i class="fas fa-caret-right"></i></a></li>
