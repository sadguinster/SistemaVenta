	...
	<table id="factura_head">
		<tr>
			...
			<td class="info_factura">
				<div class="round" >
					<span class="h3">Estado de resultado</span><br/>
					<p>Desde el: <?php echo $desde; ?></p><br/>
					<p>Hasta el: <?php echo $hasta; ?></p><br/>
					<p>Generado el: <?php echo $fecha; ?></p><br/>
					<p>Usuario: <?php echo  $usuario ?></p><br/>
				</div>
			</td>
		</tr>
