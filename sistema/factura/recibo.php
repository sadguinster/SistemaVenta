		...
		<tr>
			...
			<td class="">
				...
				<div class="round">
					...
					<p>&nbsp;&nbsp;Hora: <?php echo $data_recibo['hora']; ?></p><br/>
					<p>&nbsp;&nbsp;Usuario: <?php echo $data_recibo['nombre']; ?></p><br/>
					<strong>&nbsp;&nbsp;Cliente: <?php echo $factura['nombre']; ?></strong><br/>
					<p>&nbsp;&nbsp;Nit: <?php echo $factura['nit']; ?></p><br/>
				</div>
			</td>
		</tr>
	</table>
